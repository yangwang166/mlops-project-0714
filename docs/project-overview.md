...
```
mlops-project-0714         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_project_0714       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
