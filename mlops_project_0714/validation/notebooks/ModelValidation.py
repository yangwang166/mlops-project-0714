...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_project_0714/databricks-resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops-project-0714/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops-project-0714/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops-project-0714-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-mlops-project-0714-model", "Model Name")
