...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-project-0714-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-8405830731420074.14.azuredatabricks.net#mlflow/models/staging-mlops-project-0714-model)
* [Prod workspace registered model](https://adb-1005182519515014.14.azuredatabricks.net#mlflow/models/prod-mlops-project-0714-model)
